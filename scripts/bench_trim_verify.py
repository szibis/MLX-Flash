...
def main():
    ...
    print("=" * 90)
    print(f"  {'Config':35s} | {'tok/s':>8s} | {'accept':>7s} | {'tok/step':>8s} | "
    ...
    for bs in [16, 8, 4]:
        for trim in [False, True]:
            ...
            for _ in range(trials):
                ...
                r = DFlashRunner(model, tokenizer, d, c,
                                 inference_block_size=bs, trim_verify=trim)
            ...
            print(f"  {label:35s} | {s['tok_per_sec']:8.1f} | "
